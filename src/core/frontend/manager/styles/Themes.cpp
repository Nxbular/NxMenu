...
namespace YimMenu
{
	void DefaultStyle()
	{
		...
		style.Colors[ImGuiCol_Tab] = ImVec4(0.28f, 0.0f, 0.68f, 0.85f);
		style.Colors[ImGuiCol_TabHovered] = ImVec4(0.38f, 0.0f, 0.95f, 0.85f);
		style.Colors[ImGuiCol_TabActive] = ImVec4(0.33f, 0.0f, 0.81f, 1.00f);
		style.Colors[ImGuiCol_TabUnfocused] = ImVec4(0.23f, 0.0f, 0.55f, 0.70f);
		style.Colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.28f, 0.0f, 0.68f, 0.85f);
		...
		// Checkmarks, sliders
		style.Colors[ImGuiCol_CheckMark] = ImVec4(0.33f, 0.0f, 0.81f, 1.00f);
		style.Colors[ImGuiCol_SliderGrab] = ImVec4(0.33f, 0.0f, 0.81f, 1.00f);
		style.Colors[ImGuiCol_SliderGrabActive] = ImVec4(0.38f, 0.0f, 0.95f, 1.00f);

		// Buttons
		style.Colors[ImGuiCol_Button] = ImVec4(0.33f, 0.0f, 0.81f, 1.00f);
		style.Colors[ImGuiCol_ButtonHovered] = ImVec4(0.38f, 0.0f, 0.95f, 1.00f);
		style.Colors[ImGuiCol_ButtonActive] = ImVec4(0.43f, 0.0f, 1.0f, 1.00f);

		// Headers
		style.Colors[ImGuiCol_Header] = ImVec4(0.28f, 0.0f, 0.68f, 1.00f);
		style.Colors[ImGuiCol_HeaderHovered] = ImVec4(0.38f, 0.0f, 0.95f, 1.00f);
		style.Colors[ImGuiCol_HeaderActive] = ImVec4(0.43f, 0.0f, 1.0f, 1.00f);

		// Separators
		style.Colors[ImGuiCol_Separator] = ImVec4(0.28f, 0.28f, 0.28f, 0.50f);
		style.Colors[ImGuiCol_SeparatorHovered] = ImVec4(0.33f, 0.0f, 0.81f, 0.78f);
		style.Colors[ImGuiCol_SeparatorActive] = ImVec4(0.38f, 0.0f, 0.95f, 1.00f);
		...
		style.Colors[ImGuiCol_PlotHistogram] = ImVec4(0.33f, 0.0f, 0.81f, 1.00f);
		style.Colors[ImGuiCol_PlotHistogramHovered] = ImVec4(0.38f, 0.0f, 0.95f, 1.00f);

		// Drag & drop
		style.Colors[ImGuiCol_DragDropTarget] = ImVec4(1.00f, 1.00f, 0.00f, 0.90f);

		// Navigation highlighting
		style.Colors[ImGuiCol_NavHighlight] = ImVec4(0.33f, 0.0f, 0.81f, 1.00f);
